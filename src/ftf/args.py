...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Dry run the process, origin/main will still be force updated",
        dest="dry_run",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use a new temporary directory and clone everything again",
        dest="new_temp",
    )
    ...
    parser.add_argument(
        "--oo",
        "--origin-org",
        help="The github origin organization",
        required=True,
        dest="origin_org",
    )
